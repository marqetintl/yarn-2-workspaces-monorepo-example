...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "dependencyTreeRoots": [
      ...
      {
        "name": "@miq/myapp-1",
        "reference": "workspace:packages/myapp-1"
      },
      {
        "name": "@miq/myapp-2",
        "reference": "workspace:packages/myapp-2"
      }
    ],
    "enableTopLevelFallback": true,
    "ignorePatternData": "(^(?:\\.yarn\\/sdks(?:\\/(?!\\.)(?:(?:(?!(?:^|\\/)\\.).)*?)|$))$)",
    "fallbackExclusionList": [
      ["@miq/myapp-1", ["workspace:packages/myapp-1"]],
      ["@miq/myapp-2", ["workspace:packages/myapp-2"]],
      ["@miq/yarn-2-workspaces-monorepo-example", ["workspace:."]]
    ],
    "fallbackPool": [
    ],
    ...
    "packageRegistryData": [
      ...
      ["@miq/myapp-1", [
        ["workspace:packages/myapp-1", {
          "packageLocation": "./packages/myapp-1/",
          "packageDependencies": [
            ["@miq/myapp-1", "workspace:packages/myapp-1"],
            ["@miq/myapp-2", "workspace:packages/myapp-2"]
          ],
      ...
      ["@miq/myapp-2", [
        ["workspace:packages/myapp-2", {
          "packageLocation": "./packages/myapp-2/",
          "packageDependencies": [
            ["@miq/myapp-2", "workspace:packages/myapp-2"]
          ],
          "linkType": "SOFT",
      ...
      ["@miq/yarn-2-workspaces-monorepo-example", [
        ["workspace:.", {
          "packageLocation": "./",
          "packageDependencies": [
            ["@miq/yarn-2-workspaces-monorepo-example", "workspace:."]
